<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/IFrame.Master"
    AutoEventWireup="true" CodeBehind="ModifyCatalog.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.SysMger.ModifyCatalog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="myTabContent" class="tab-content areacolumn">
        <div class="fix white-bg">
            <ul>
                <li class="mb-20"><span class="formitemtitle"><em>*</em>Tên menu:</span>
                    <div class="w400 fl">
                        <asp:TextBox ID="TextBox1" runat="server" class="form-control" required="required"
                            placeholder="Vui lòng nhập tên menu 如 Các mặt hàng" MaxLength="50"></asp:TextBox>
                    </div>
                    <i class="iconfont ml-20 hidden" data-toggle="tooltip" data-placement="right" title="Vui lòng nhập tên menu ví dụ quản lý cửa hàng ">
                        &#xe613;</i>
                    <p class="clear m-l-160 text-danger hidden">
                        Chủ đề trưng bày！</p>
                </li>
                <li class="mb-20"><span class="formitemtitle"><em>*</em>Mã:</span>
                    <div class="w400 fl">
                        <asp:TextBox ID="TextBox2" runat="server" class="form-control" required="required"
                            placeholder="Vui lòng nhập phần mã như StoreManager" MaxLength="50"></asp:TextBox>
                    </div>
                </li>
