<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="RefundApply.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.OrderMger.RefundApply" %>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <span data-toggle="tooltip" data-placement="top" title='<%#Eval("ProductName")%>'>
                                                    <%#SinGooCMS.Utility.StringUtils.Cut(Eval("ProductName").ToString(), 30, "...")%>
                                                </span>
                                            </td>
                                            <td>
                                                <%#Eval("AutoTimeStamp")%>
                                            ...
                                            <td>
                                                <%#SinGooCMS.Utility.EnumUtils.GetEnumDescription((SinGooCMS.RefundGoodsStatus)SinGooCMS.Utility.WebUtils.GetInt(Eval("Status")))%>
                                            </td>
                                            <td class="text-muted">
                                                <a href="javascript:void(0)" onclick="location='ModifyRefundApply.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=Modify&opid=<%#Eval("AutoID") %>'">
                                                    Chi tiết</a>
