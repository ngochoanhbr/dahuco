<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="DeliveryRec.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.OrderMger.DeliveryRec" %>
                    ...
                    <div class="profile-body mb-20">
                        <div class="form-group fix hidden">
                            <label for="firstname" class="sr-only">
                                singoocms</label>
                            <div class="col-md-3">
                                <asp:TextBox ID="search_text" runat="server" CssClass="form-control" placeholder="Vui lòng nhập số thứ tự"></asp:TextBox>
                            </div>
                            <label for="firstname" class="sr-only">
                                singoocms</label>
                            <div class="col-md-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span data-toggle="tooltip" data-placement="top" title='<%#Eval("ProductName")%>'>
                                                    <%#SinGooCMS.Utility.StringUtils.Cut(Eval("ProductName").ToString(),12,"...")%>
                                                </span>
                                            </td>
                                            <td>
                                                Diễn tả：<%#Eval("KuaidiCom")%> ，[số vận đơn：<%#Eval("ShippingNo")%>]
                                            </td>
                                            <td>
                                                <%#Eval("AutoTimeStamp")%>
                                            </td>
