<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="GatheringRec.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.OrderMger.GatheringRec" %>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#SinGooCMS.Utility.WebUtils.GetDecimal(Eval("OrderAmount")).ToString("C2")%>
                                            </td>
                                            <td>
                                                <%#Eval("PayTypeName")%> [tài khoản thanh toán：<%#Eval("PayUserName")%>]
                                            </td>
                                            <td>
                                                <%#Eval("AutoTimeStamp")%>
                                            </td>
