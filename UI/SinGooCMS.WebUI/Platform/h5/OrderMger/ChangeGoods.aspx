<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="ChangeGoods.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.OrderMger.ChangeGoods" %>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <span data-toggle="tooltip" data-placement="top" title='<%#Eval("GoodsName")%>'>
                                                    <%#SinGooCMS.Utility.StringUtils.Cut(Eval("GoodsName").ToString(),30,"...")%>
                                                </span>                                                
                                            </td>
                                            <td>
                                                <%#Eval("AutoTimeStamp")%>
                                            ...
                                            <td>
                                                <%#SinGooCMS.Utility.EnumUtils.GetEnumDescription((SinGooCMS.ChangeGoodsStatus)SinGooCMS.Utility.WebUtils.GetInt(Eval("Status")))%>
                                            </td>
                                            <td class="text-muted">
                                                <a href="javascript:void(0)" onclick="location='ModifyChangeGoods.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=Modify&opid=<%#Eval("AutoID") %>'">Chi tiết</a>
