<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/IFrame.Master"
    AutoEventWireup="true" CodeBehind="UserForSelectMobile.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.Selector.UserForSelectMobile" %>
                                        ...
                                        <tr>
                                            <td>
                                                <input type='<%=(SelectType=="single"?"radio":"checkbox") %>' name="inputcheck" id='<%#Eval("AutoID") %>'
                                                    title="Lựa chọn thiết bị" value='<%# Eval("Mobile") %>' class="checkbox_radio" />
