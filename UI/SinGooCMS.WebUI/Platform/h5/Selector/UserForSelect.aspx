<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/IFrame.Master"
    AutoEventWireup="true" CodeBehind="UserForSelect.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.Selector.UserForSelect" %>
                            ...
                            <tbody>
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <input type='<%=(SelectType=="single"?"radio":"checkbox") %>' name="inputcheck" id='<%#Eval("AutoID") %>' title="Lựa chọn 器" value='<%# Eval("UserName") %>' class="checkbox_radio"/>
