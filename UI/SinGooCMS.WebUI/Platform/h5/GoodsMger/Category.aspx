<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.GoodsMger.Category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid all">
                    ...
                    <div class="profile-body mb-20">
                        <div class="form-group fix hidden">
                            <label for="firstname" class="sr-only">
                                singoocms</label>
                            <div class="col-md-3">
                                <asp:TextBox ID="search_text" runat="server" CssClass="form-control" placeholder="Tên danh mục"></asp:TextBox>
                            </div>
                            <label for="firstname" class="sr-only">
                                singoocms</label>
                            <div class="col-md-3">
                        ...
                        <div class="batchHandleArea fix">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-warning" onclick="location='ModifyCategory.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=Add'">
                                    Thêm</button>
                            </div>
                            <div class="fr">
                                <div class="col-md-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class='CateLevel<%#Eval("Depth") %>'>
                                                    ...
                                                    <%#SinGooCMS.Utility.WebUtils.GetInt(Eval("ParentID")).Equals(0) ? "<b>" + Eval("CategoryName").ToString() + "</b>" : Eval("CategoryName").ToString()%>
                                                    (ID:#<%#Eval("AutoID") %>) </span>
                                            </td>
                                            <td>
                                                <%#Eval("UrlRewriteName")%>
                                            ...
                                            <td class="text-muted">
                                                <a href="ModifyCategory.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=Modify&opid=<%#Eval("AutoID") %>">Sửa</a> 
                                                <asp:LinkButton ID="lnk_Delete" Text="Xóa" CssClass="del" runat="server" OnClientClick="return confirm('Bạn có chắc chắn xóa?')" CommandArgument='<%#Eval("AutoID") %>' OnClick="lnk_Delete_Click" />
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
        ...
        <div id="importdata">
            ...
            <asp:Button runat="server" ID="btn_Import" Text="Gửi dữ liệu để xác định phân loại" OnClick="btn_Import_Click"
                class="btn btn-default" />
            <p style="padding: 10px 0">
                <span style="color: Red"><i class='iconfont mt-20' title=''>&#xe613;</i>Hãy tải lên thông số định dạng tập tin XML. Import tập tin có thể dẫn đến việc mất phân loại dữ liệu, xin vui lòng thực hiện một bản sao lưu trước khi chạy</span></p>
        </div>
    </div>
