<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.GoodsMger.Cart" %>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#Eval("ProName")%> x <%#Eval("Quantity")%>
                                            </td>
                                            <td>
                                                <%#SinGooCMS.Utility.WebUtils.GetDecimal(Eval("Price")).ToString("f2")%>
                                            </td>
                                            <td>
                                                <%#Eval("AutoTimeStamp")%>
                                            </td>
