<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="ProField.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.GoodsMger.ProField" %>
    ...
    <div class="container-fluid all">
        ...
        <div class="profile-wrapper">
            ...
            <ul id="myTab" class="nav nav-tabs container-fluid">
                <li><a href="javascript:;" data-toggle="tab" onclick="location='ProModel.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View'">
                    Mẫu hàng hóa</a></li>
