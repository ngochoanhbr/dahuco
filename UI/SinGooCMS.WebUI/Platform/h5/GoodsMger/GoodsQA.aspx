<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="GoodsQA.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.GoodsMger.GoodsQA" %>
        ...
        <div class="profile-wrapper">
            ...
            <ul id="myTab" class="nav nav-tabs container-fluid">
                <li <%=status==0?"class='active'":"" %>><a href="javascript:;" data-toggle="tab"
                    onclick="location='GoodsQA.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&status=0&action=View'">
                    Chưa trả lời</a></li>
                <li <%=status==1?"class='active'":"" %>><a href="javascript:;" data-toggle="tab"
                    onclick="location='GoodsQA.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&status=1&action=View'">
                    Đã trả lời</a></li>
            </ul>
                    ...
                    <div class="profile-body mb-20">
                        <div class="form-group fix hidden">
                            <label for="firstname" class="sr-only">
                                singoocms</label>
                            <div class="col-md-3">
                                <asp:TextBox ID="search_text" runat="server" CssClass="form-control wicon" placeholder="Các mặt hàng"></asp:TextBox>
                            </div>
                            <label for="firstname" class="sr-only">
                                singoocms</label>
                            <div class="col-md-3">
                    ...
                    <div class="profile-body mb-20 fix">
                        <div class="p_replyed">
                            <div class="p_replyed_title">
                                <span class="p_replyed_user">Người phản hồi</span> <span class="p_replyed_por">Các mặt hàng</span>
                                <span class="p_replyed_time">Thời gian</span> <span class="p_replyed_operation">Xử lý</span>
                            </div>
                        </div>
                        <div id="rowItems">
                                    ...
                                    <div class="order_hover">
                                        <div class="replyed_info_title">
                                            ...
                                            <div class="replyed_info_operation">
                                                <a href="javascript:;" onclick="$.dialog.open('GoodsQADetail.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View&opid=<%#Eval("AutoID") %>',{title:'Tư vấn Chi tiết',width:680,height:390},false);">
                                                    Chi tiết</a>
