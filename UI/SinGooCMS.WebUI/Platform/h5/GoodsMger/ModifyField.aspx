<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="ModifyField.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.GoodsMger.ModifyField" %>
    ...
    <div class="container-fluid all">
        ...
        <div class="profile-wrapper">
            ...
            <ul id="myTab" class="nav nav-tabs container-fluid">
                <li><a href="ProModel.aspx?CatalogID=<%=CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View">
                    Mẫu hàng hóa</a></li>
                <li><a href="ProField.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&ModelID=<%=intModelID%>&action=View">
                    Trường mở rộng</a></li>
                ...
                <div class="datafrom">
                    ...
                    <div class="form-group mt-20 fix">
                        <label for="firstname" class="col-md-3 control-label">
                            Tên hiển thị</label>
                        <div class="col-md-4">
                            <asp:TextBox placeholder="Tên hiển thị" ID="TextBox3" runat="server" required="required"
                    ...
                    <div class="form-group mt-20 fix ext extchild" style="display: none" id="attr11">
                        ...
                        <i class="iconfont ml-20" data-toggle="tooltip" data-placement="right" title="Không đồng bộ nhập đường dẫn url, dữ liệu trở lại Json <br/> (KeyName / KeyValue cặp khóa-giá trị), tùy thuộc vào ParentID ">
                            &#xe613;</i>
                    </div>
                    <!--不同Lựa chọn  Kết thúc-->
                    <div class="form-group mt-20 fix">
            ...
            <div class="profile-body mb-20">
                <div class="datafrom text-right">
                    ...
                    <input id="btncancel" onclick="location='ProField.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&ModelID=<%=intModelID%>&action=View'"
