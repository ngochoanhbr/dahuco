<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="AreaModelList.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.GoodsMger.AreaModelList" %>
                    ...
                    <div class="profile-body mb-20">
                        <div class="form-group fix hidden">
                            <label for="firstname" class="sr-only">
                                singoocms</label>
                            <div class="col-md-3">
                                <asp:TextBox ID="search_text" runat="server" CssClass="form-control" placeholder="Tên bản mẫu"></asp:TextBox>
                            </div>
                            <label for="firstname" class="sr-only">
                                singoocms</label>
                            <div class="col-md-3">
                        ...
                        <div class="batchHandleArea fix">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-warning" onclick="location='ModifyAreaModel.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=Add'">
                                    Thêm</button>
                            </div>
                            <div class="fr">
                                <div class="col-md-12">
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#SinGooCMS.Utility.StringUtils.Cut(Eval("Description").ToString(),50,"...")%>
                                            </td>
                                            <td class="text-muted">
                                                <a href="ModifyAreaModel.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=Modify&opid=<%#Eval("AutoID") %>"
