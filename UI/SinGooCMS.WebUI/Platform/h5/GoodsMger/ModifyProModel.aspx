<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/IFrame.Master"
    AutoEventWireup="true" CodeBehind="ModifyProModel.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.GoodsMger.ModifyProModel" %>
                ...
                <li class="mb-20"><span class="formitemtitle"><em>*</em>Tên model:</span>
                    <div class="w400 fl">
                        <asp:TextBox ID="TextBox1" runat="server" class="form-control" required="required"
                            placeholder="Vui lòng nhập tên model chung cho các sản phẩm" MaxLength="50"></asp:TextBox>
                    </div>
                </li>
                <li class="mb-20"><span class="formitemtitle"><em>*</em>Bảng dữ liệu:</span>
                    <div class="w400 fl">
                        <div class="input-group">
                            <span class="input-group-addon">shop_P_</span>
