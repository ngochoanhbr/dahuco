<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="ModifyPaymentSet.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.WeixinMger.ModifyPaymentSet" %>
    ...
    <div class="container-fluid all">
        ...
        <div class="profile-wrapper">
            ...
            <ul id="myTab" class="nav nav-tabs container-fluid">
                <li><a href="javascript:;" data-toggle="tab" onclick="location='WeixinPaySet.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View'">
            ...
            <div class="profile-body mb-20 areacolumn">
                <div class="datafrom">
                    <h2 class="title">
                        <%=Action=="Add"?"ThêmCấu hình thanh toán":"Chỉnh sửa Cấu hình thanh toán" %></h2>
                    <div class="form-group mt-20 fix">
                        ...
                        <i class="iconfont ml-20" data-toggle="tooltip" data-placement="right" title="Thanh toán是唯一的">
                            &#xe613;</i>
                    </div>
                    <div id="paramarea">
                    </div>
            ...
            <div class="profile-body mb-20">
                <div class="datafrom text-right">
                    ...
                    <input id="btncancel" onclick="location='MobilePaySet.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View'"
