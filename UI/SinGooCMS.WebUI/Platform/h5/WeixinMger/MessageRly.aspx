<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="MessageRly.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.WeixinMger.MessageRly" %>
                ...
                <div class="datafrom">
                    ...
                    <div class="form-group mt-20 fix">
                        <label for="firstname" class="col-md-3 control-label">
                            <em>*</em>nội dung</label>
                        <div class="col-md-5">
                            <asp:TextBox TextMode="MultiLine" ID="TextBox1" runat="server" Rows="5" Columns="80"
                                CssClass="form-control" required="required" placeholder="Vui lòng nhập nội dung trả lời" lenlimit="2000"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group mt-20 fix">
                        <label for="firstname" class="col-md-3 control-label">
                    ...
                    <div class="form-group mt-20 fix">
                        ...
                        <div class="col-md-5">
                            <asp:TextBox ID="TextBox3" runat="server" Rows="5" Columns="60" CssClass="form-control"
                                TextMode="MultiLine" placeholder="Nhập mô tả trả lời" lenlimit="2000"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group mt-20 fix">
                        <label for="firstname" class="col-md-3 control-label">
