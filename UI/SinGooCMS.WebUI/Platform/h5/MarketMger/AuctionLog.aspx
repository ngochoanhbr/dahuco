<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="AuctionLog.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.MarketMger.AuctionLog" %>
        ...
        <div class="profile-wrapper">
            ...
            <ul id="myTab" class="nav nav-tabs container-fluid">
                <li><a href="javascript:;" data-toggle="tab" onclick="location='Auction.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View'">
                    Bán đấu giá</a></li>
                <li class="active"><a href="javascript:;" data-toggle="tab">Hồ sơ đấu giá</a></li>
            </ul>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#Convert.ToDecimal(Eval("AfterAmount")).ToString("f2")%>
                                            </td>
                                            <td>
                                                <%#Eval("AutoTimeStamp")%>
                                            </td>
