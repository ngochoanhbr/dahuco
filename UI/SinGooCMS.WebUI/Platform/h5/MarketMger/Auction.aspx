<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="Auction.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.MarketMger.Auction" %>
                ...
                <ContentTemplate>
                    <div class="profile-body mb-20">
                        ...
                        <div class="batchHandleArea fix">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-warning" onclick="location='ModifyAuction.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=Add'">
                                    Thêm</button>
                            </div>
                            <div class="fr">
                                <div class="col-md-12">
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#SinGooCMS.Utility.WebUtils.GetDecimal(Eval("CurrPrice")).ToString("f2")%>
                                            </td>
                                            <td>
                                                <asp:TextBox style="width:80px;" runat="server" ID="txtsort" class="form-control text-center" Text='<%#Eval("Sort") %>'></asp:TextBox>
                                            </td>
                                            <td class="text-muted">
                                                <a href="javascript:void(0)" onclick="location='ModifyAuction.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=Modify&opid=<%#Eval("AutoID") %>'">Sửa</a> 
                                                <a href="AuctionLog.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View&AuctionID=<%#Eval("AutoID") %>">Hồ sơ đấu giá</a>
