<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="ContField.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.ContMger.ContField" %>
    ...
    <div class="container-fluid all">
        ...
        <div class="profile-wrapper">
            ...
            <ul id="myTab" class="nav nav-tabs container-fluid">
                <li><a href="javascript:;" data-toggle="tab" onclick="location='ContModelList.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View'">
                   Mẫu nội dung</a></li>
            ...
            <div class="profile-body mb-20">
                ...
                <div class="batchHandleArea fix">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-warning" onclick="location='ModifyField.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&ModelID=<%=intModelID %>&action=Add'">
                            Thêm</button>
                    </div>
                    <div class="fr">
                        <div class="col-md-12">
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="text-muted">
                                                <a href="javascript:void(0)" onclick="location='ModifyField.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&ModelID=<%=intModelID %>&opid=<%#Eval("AutoID") %>&action=Modify'">
                                                    Sửa</a>
