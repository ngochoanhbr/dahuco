<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="ModifyField.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.ContMger.ModifyField" %>
    ...
    <div class="container-fluid all">
        ...
        <div class="profile-wrapper">
            ...
            <ul id="myTab" class="nav nav-tabs container-fluid">
                <li><a href="ContModelList.aspx?CatalogID=<%=CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View">
                    Model sản phẩm</a></li>
                <li><a href="ContField.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&ModelID=<%=intModelID%>&action=View">
                    Trường mở rộng</a></li>
                <li class="active"><a href="javascript:void(0)">Sửa trường</a></li>
            </ul>
            <div class="profile-body mb-20 areacolumn">
                <div class="datafrom">
                    ...
                    <div class="form-group mt-20 fix ext extchild" style="display: none" id="attr11">
                        ...
                        <i class="iconfont ml-20" data-toggle="tooltip" data-placement="right" title="Nhập url，Json trả về (KeyName/KeyValue)">
                            &#xe613;</i>
                    </div>
                    <!--不同Lựa chọn  Kết thúc-->
                    <div class="form-group mt-20 fix">
            ...
            <div class="profile-body mb-20">
                <div class="datafrom text-right">
                    ...
                    <input id="btncancel" onclick="location='ContField.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&ModelID=<%=intModelID%>&action=View'"
