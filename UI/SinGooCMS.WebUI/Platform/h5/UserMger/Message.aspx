<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="Message.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.UserMger.Message" %>
        ...
        <div class="profile-wrapper">
            ...
            <ul id="myTab" class="nav nav-tabs container-fluid">
                <li class="active"><a href="javascript:;">
                    Thông báo</a></li>
                <li><a href="SendMeaageBat.aspx?CatalogID=<%=CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View">
                    Gửi tin nhắn</a></li>
            </ul>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="text-muted">
                                                <a href="javascript:void(0)" onclick="$.dialog.open('../Tools/MyMsgBoxDetail.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=Modify&opid=<%#Eval("AutoID") %>',{title:'Xem thông báo',width:580,height:350},false);">Xem</a>
