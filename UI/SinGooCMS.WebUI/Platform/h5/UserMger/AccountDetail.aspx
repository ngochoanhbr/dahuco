<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="AccountDetail.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.UserMger.AccountDetail" %>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#Eval("OpType").ToString()=="1"?"+":"-"%>
                                                <%#Convert.ToDecimal(Eval("OpValue")).ToString("f2")%>
                                                <%#Eval("Unit").ToString()=="Amount"?"元":"积分" %>
                                            </td>
                                            <td>
                                                <%#Convert.ToDecimal(Eval("After")).ToString("f2")%>
                                                <%#Eval("Unit").ToString()=="Amount"?"元":"积分" %>
                                            </td>
                                            <td>
                                                <%#Eval("Remark")%>
