<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="AdsList.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.ADMger.AdsList" %>
    ...
    <div class="container-fluid all">
        ...
        <div class="profile-wrapper">
            ...
            <ul id="myTab" class="nav nav-tabs container-fluid">
                ...
                <li class="active"><a href="javascript:;" data-toggle="tab" onclick="location='AdsList.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=View'">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="profile-body mb-20">
                        <div class="datafrom">
                            <h2 class="title">
                                <%=currAdPlace.PlaceName%> Chi tiết quảng cáo</h2>
                        </div>
                        <div class="form-group fix hidden">
                            <label for="firstname" class="sr-only">
                                singoocms</label>
                            <div class="col-md-3">
                                <asp:TextBox ID="search_text" runat="server" CssClass="form-control" placeholder="Vui lòng nhập tên của quảng cáo"></asp:TextBox>
                            </div>
                            <label for="firstname" class="sr-only">
                                singoocms</label>
                            <div class="col-md-3">
                        ...
                        <div class="batchHandleArea fix">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-warning" onclick="location='ModifyAd.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&PlaceID=<%=currAdPlace.AutoID %>&action=Add'">
                                    Thêm</button>
                            </div>
                            <div class="fr">
                                <div class="col-md-12">
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#Eval("IsAudit").ToString()=="True"?"Đã duyệt":"Chưa duyệt"%>
                                            </td>
                                            <td>
                                                <a href="ModifyAd.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&action=Modify&opid=<%#Eval("AutoID") %>">Sửa</a>
