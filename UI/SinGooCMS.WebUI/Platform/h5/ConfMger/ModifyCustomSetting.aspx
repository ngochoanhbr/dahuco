<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="ModifyCustomSetting.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.ConfMger.ModifyCustomSetting" %>
    ...
    <div class="container-fluid all">
        ...
        <div class="profile-wrapper">
            ...
            <ul id="myTab" class="nav nav-tabs container-fluid">
                ...
                <li><a href="CustomSetting.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&cateid=<%=cate.AutoID%>&action=View">
                    Danh sách cấu hình</a></li>
                <li class="active"><a href="javascript:void(0)">SửaCấu hình</a></li>
            </ul>
            <div class="profile-body mb-20 areacolumn">
                <div class="datafrom">
                    <h2 class="title">
                        <%=Action == "Add" ? "Thêm Cấu hình tùy chọn" : "Chỉnh sửa Cấu hình tùy chọn"%></h2>
                    ...
                    <div class="form-group mt-20 fix">
                        <label for="firstname" class="col-md-3 control-label">
                            Key cấu hình</label>
                        <div class="col-md-4">
                            <asp:TextBox ID="TextBox1" runat="server" placeholder="Vui lòng nhập tên trường, ví dụ Title" required="required"
                    ...
                    <div class="form-group mt-20 fix">
                        <label for="firstname" class="col-md-3 control-label">
                            Tên hiển thị</label>
                        <div class="col-md-4">
                            <asp:TextBox placeholder="Nhập tên hiển thị" ID="TextBox3" runat="server" required="required"
                    ...
                    <div class="form-group mt-20 fix ext" id="attr4" style="display:none">
                        <label for="firstname" class="col-md-3 control-label">
                            Kiểu Datetime</label>
                        <div class="col-md-4">
                            <asp:TextBox ID="ExtTextBox4" runat="server" class="form-control" Text="yyyy-MM-dd" MaxLength="20"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group mt-20 fix ext" id="attr5" style="display:none">
                        ...
                        <div class="col-md-2">
                            <jweb:H5TextBox Mode="Number" ID="ExtTextBox5" runat="server" Text="50" class="form-control" MaxLength="10"></jweb:H5TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group mt-20 fix ext extchild" style="display:none" id="attr8">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="ExtTextBox8" runat="server" class="form-control"></asp:TextBox>
                            <input type="button" id="btn_getdict" class="btn-normal" value="Chọn từ điển" onclick="$.dialog.open('../Selector/DictForSelect.aspx?Module=<%=base.CurrentModuleCode %>&elementid=<%=ExtTextBox8.ClientID %>&type=single',{title:'Chọn từ điển',width:680,height:450},false);" />
                        </div>
                    </div>
            ...
            <div class="profile-body mb-20">
                <div class="datafrom text-right">
                    ...
                    <input id="btncancel" onclick="location='CustomSetting.aspx?CatalogID=<%=base.CurrentCatalogID %>&Module=<%=base.CurrentModuleCode %>&cateid=<%=cate.AutoID%>&action=View'"
