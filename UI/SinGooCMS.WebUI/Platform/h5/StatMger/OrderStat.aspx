<%@ Page Title="" Language="C#" MasterPageFile="~/Platform/h5/MasterPage/MasterDefault.Master"
    AutoEventWireup="true" CodeBehind="OrderStat.aspx.cs" Inherits="SinGooCMS.WebUI.Platform.h5.StatMger.OrderStat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showChart(timestart, timeend, statby, shape, showdiv) {
            ...
            $.get("XmlProvider/GetOrderStatData.ashx", { t: "getchart", st: timestart, dt: timeend, sy: statby, temp: Math.random() }, function (result) {
        ...
        $(function () {
            ...
            showChart('<%=System.DateTime.Now.AddDays(-6).ToString("yyyy-MM-dd")%>', '<%=System.DateTime.Now.ToString("yyyy-MM-dd")%>', 'Tuần', $("#shape").find("option:selected").val(), 'chartDiv');
        });
