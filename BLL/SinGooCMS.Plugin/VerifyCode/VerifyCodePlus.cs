...
{
    public class VerifyCodePlus : IVerifyCode
    {
        #region 私有属性
        ...
        public string GenerateCheckCode()
        {
            ...
            int chkParamA = rnd.Next(0, 10); //参与运算参数A
            int chkParamB = rnd.Next(0, 10); //参与运算参数B           

            intResult = chkParamA + chkParamB;
            return chkParamA.ToString() + "+" + chkParamB.ToString() + "=?";
        }
