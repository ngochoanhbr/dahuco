...
namespace SinGooCMS.Entity 
{
    ...
    /// </summary>
    [Serializable]
    public partial class ProductModelInfo : JObject, IEntity
    {        
        #region 私有字段
        ...
        public string Fields
        {
            get
            {
                return "AutoID,ModelName,TableName,ModelDesc,IsUsing,Sort,Creator,AutoTimeStamp";
            }            
        }
        /// <summary>
        /// 数据表字段
