...
{
	public class Stockout : H5ManagerPageBase
	{
		public int kcType = 0;
		...
		{
			this.kcType = WebUtils.GetQueryInt("type");
			if (!base.IsPostBack)
			{
				this.BindData();
			}
		...
		private void BindData()
		{
			...
			this.Repeater1.DataSource = SinGooCMS.BLL.Stockout.GetPagerList(this.GetCondition(), strSort, this.SinGooPager1.PageIndex, this.SinGooPager1.PageSize, ref recordCount, ref num);
		...
		{
			string text = " 1=1 AND Type=" + this.kcType;
		...
		protected void btn_DelBat_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				{
					if (SinGooCMS.BLL.Stockout.Delete(repeaterCheckIDs))
					{
						this.BindData();
						PageBase.log.AddEvent(base.LoginAccount.AccountName, "批量删除缺货登记成功");
						base.ShowAjaxMsg(this.UpdatePanel1, "Thao tác thành công");
					}
					else
					{
