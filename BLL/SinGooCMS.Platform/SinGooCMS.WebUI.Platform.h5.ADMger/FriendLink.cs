...
{
	public class FriendLink : H5ManagerPageBase
	{
		...
		private void BindData()
		{
			...
			this.Repeater1.DataSource = Links.GetPagerList(this.GetCondition(), strSort, this.SinGooPager1.PageIndex, this.SinGooPager1.PageSize, ref recordCount, ref num);
		...
		private string GetCondition()
		{
			...
			{
				text = text + " AND LinkName like '%" + WebUtils.GetString(this.search_text.Text) + "%' ";
			}
			return text;
		}
		...
		protected void btn_SaveSort_Click(object sender, System.EventArgs e)
		{
			...
			{
				if (Links.UpdateSort(repeaterSortDict))
				{
					this.BindData();
					PageBase.log.AddEvent(base.LoginAccount.AccountName, "更新友情链接排序成功");
					base.ShowAjaxMsg(this.UpdatePanel1, "Thao tác thành công");
				}
				else
				{
