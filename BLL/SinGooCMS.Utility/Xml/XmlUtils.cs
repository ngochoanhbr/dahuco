...
namespace SinGooCMS.Utility
{
    ...
    public sealed class XmlUtils
    {
        ...
        #region 私有函数
        /// <summary>
        /// 创建xml文件,如果文件名没有指定则为liqiang665.xml,根元素名为liqiang665Root
        /// </summary>
        ...
        private bool CreateXML(string xmlName)
        {
            ...
            try
            {
                ...
                {
                    //如果没有指定文件名则创建一个默认的liqiang665.xml
                    xmltx = new XmlTextWriter(HttpContext.Current.Server.MapPath("liqiang665.xml"), Encoding.UTF8);
                }
                else
                {
                    //指定的文件名
                ...
                xmltx.WriteStartElement("liqiang665Root");
        ...
        /// <returns>指定的XML描述文件的绝对路径,server.mappath</returns>
        ...
        /// <summary>
        /// 通过文件XML绝对路径,获取并返回一个xmldoc对象
        /// </summary>
        /// <param name="tempXmlFilePath">绝对路径</param>
        /// <returns></returns>
        ...
        /// 构造函数
        /// </summary>
        /// <param name="tempXmlFilePath">XML文件绝对路径,server.mappath</param>
        public XmlUtils(string tempXmlFilePath)
        {
        ...
        public string GetXmlNodeValue(int Index, string strNodePath, string childNodeName)
        {
            ...
            {
                throw new KeyNotFoundException("未找到节点：" + strNodePath + "/" + childNodeName);
            }
        }
        /// <summary>
        /// 获取节点的值
